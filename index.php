...
<html>
	<head>
		...
		<title>Just Me!</title>
			...
			<body>
				<div class="bg-blue border-black" id="paragraph-1">
					<h1>Rockabilly Guitar</h1>
				<p>I'm going to write a little bit about me, mainly my hobby and passion, music!! I play bluegrass guitar, dobro, pedal steel guitar
				...
				<div class="bg-red border-black" id="paragraph-2">

					<h2>Influences</h2>
					<p>My influences in the acoustic guitar are Doc Watson and Clarance White. They were both
